...
/// <summary>
/// Обработчик для <see cref="PostUpdateInputAnswerCommand"/>
/// </summary>
/// <param name="userManager"></param>
/// <param name="userContext"></param>
/// <param name="dbContext"></param>
public class PostUpdateInputAnswerCommandHandler(
    UserManager<User> userManager, 
    IUserContext userContext,
    IDbContext dbContext
) : IRequestHandler<PostUpdateInputAnswerCommand>
{
    /// <inheritdoc />
    public async Task Handle(PostUpdateInputAnswerCommand request, CancellationToken cancellationToken)
    {
        if (request is null)
        ...
        answer.InputAnswer = request.Answer;
